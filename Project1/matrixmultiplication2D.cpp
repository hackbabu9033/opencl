...
//
//	FILE* fp;
//	char filename[] = "./matrixmulti2D.cl";
//	errno_t err;
//	char* source_str;
//	size_t source_size;
//	size_t file_size;
...
//	printf("Get cur platformid1=>%d\n", platform_id[0]);
//	printf("Get cur platformid2=>%d\n", platform_id[1]);
//	ret = clGetDeviceIDs(platform_id[0], CL_DEVICE_TYPE_CPU, 1, &device_id, &ret_num_devices);
...
//	}
//
//	kernel = clCreateKernel(program, "MatrixMultiple2D", &errorcode);
//
//	if (kernel == NULL) {
//		return 0;
//	}
